    ...
    return (
        <div>
            <div className='flex gap-0 flex-col lg:flex-row justify-center py-10'>
                <div>
                    <Image src="https://cdn10.bigcommerce.com/s-tkkmz5sk/product_images/uploaded_images/hop-on-hop-off-miami-double-decker-sightseeing-bus-tour.jpg" alt="" className='lg:w-[600px] lg:h-[400px] rounded-2xl' />
                </div>
